...
class Projects_model extends CI_Model{
	...
	function create_project(){
		...
		$road_length_target=$this->input->post('road_length_target');
		...
		$assembly_constituency_id = $this->input->post('assembly_constituency_id');
		$parliament_constituency_id = $this->input->post('parliament_constituency_id');
		$data=array(
			...
			'road_length_target'=>$road_length_target,
	...
	function update_project(){
		...
		$work_type=$this->input->post('work_type');
		$road_length_target=$this->input->post('road_length_target');
		$road_length_completed=$this->input->post('road_length_completed');
		$sanction_type=$this->input->post('sanction_type');
		...
		$category1_id = $this->input->post('category1_id');
		$category2_id = $this->input->post('category2_id');
		$mandal_id = $this->input->post('mandal');
		$division_id = $this->input->post('division');
		$district_id = $this->input->post('district');
		$assembly_constituency_id = $this->input->post('assembly_constituency');
		$parliament_constituency_id = $this->input->post('parliament_constituency');
		$project_data=array(
		'project_name'=>$project_name,
		...
		'work_type_id'=>$work_type,
		'road_length_target'=>$road_length_target,		
		'road_length_completed'=>$road_length_completed,		
		'sanction_type_id'=>$sanction_type,
		'staff_id'=>$staff,
		'category1_id'=>$category1_id,
		'category2_id'=>$category2_id,
	...
	function update_pendency(){
		...
		$project_id=$this->input->post('selected_project');
                ...
                $pendency_string = $this->input->post("pendency_comment");
                
		$data=array(
		'project_id'=>$project_id,
		'pendency_type_id'=>$pendency_type,
		'pendency_date'=>$pendency_date,
                'pendency_details'=>$pendency_string
		);
	...
	function remove_image($image_id,$path){
		...
		echo $path;
		if(unlink("/home/apedpadmin/public_html".$path))
		$this->db->trans_complete();
