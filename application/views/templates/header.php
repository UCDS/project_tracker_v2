...
<head>
	...
	<title><?php echo $title; ?> - APPRED</title>
    ...
    <div class="navbar navbar-default navbar-static-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">APPRED</a>
					...
					<ul class="dropdown-menu" role="menu">
				  	<li class="disabled"><a href="#">Summary</a></li>
						<?php foreach($functions as $f){
							if($f->user_function == "Reports - Dashboard"){ ?>
							<li><a href="<?php echo base_url();?>reports/dashboard">Dashboard</a></li>
						<?php break; }
						}
						...
						foreach($functions as $f){
							...
							<li><a href="<?php echo base_url();?>reports/summary/district_divisions">District - Division</a></li>
						<?php break; }
						}
						/*
						foreach($functions as $f){
