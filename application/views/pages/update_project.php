  ...
  $("#status").on('change',function(){
	...
	<div class="row">
		<div class="col-md-10">
			...
			<?php } ?>
			<h4><small>Project:</small> <?php echo $project[0]->project_name; ?></h4>
			...
			<tr>
			<td>Length Target in Kms</td>
			<td><input type="text" class="form-control" placeholder="Length Target in Kms" value="<?php echo $p->road_length_target; ?>" id="road_length_target" name="road_length_target"  /></td>
			</tr>
			<tr>
			<td>Length Completed in Kms</td>
			<td><input type="text" class="form-control" placeholder="Length Completed in Kms" value="<?php echo $p->road_length_completed; ?>" id="road_length_completed" name="road_length_completed"  /></td>
			</tr>
			<tr>
				<td>Sanction Type</td>
				<td>
			...
			<tr>
				...
				<td>
					...
					<?php foreach($districts as $district){
						...
						if($district->district_id == $p->district_id) echo " selected ";
						echo ">$district->district_name</option>";
					}
					?>
					</select>	
				</td>
			...
			<tr>
				...
				<td>
					...
					<?php foreach($divisions as $division){
						echo "<option value='$division->division_id' class='$division->district_id' ";
			...
			<tr>
				<td>Mandal</td>
				<td>		
					<select name="mandal" id="mandal" class="form-control" required>
					<option value="">--SELECT--</option>
					<?php foreach($mandals as $mandal){
						echo "<option value='$mandal->mandal_id' class='$mandal->district_id'";
						if($mandal->mandal_id == $p->mandal_id) echo " selected ";
			...
			<tr>
				...
				<td>		
					...
					<?php foreach($category1 as $category){
						...
						if($category->category_id == $p->category1_id) echo " selected  ";
			...
			<tr>
				...
				<td>		
					...
					<?php foreach($category2 as $category){
						echo "<option value='$category->category_id' ";
						if($category->category_id == $p->category2_id) echo " selected  ";
						echo ">$category->category_name</option>";
					}
					?>
					</select>	
			...
			<tr>
				...
				<td>		
					<select name="assembly_constituency" id="assembly_constituency_id" class="form-control" required>
					<option value="">--SELECT--</option>
					<?php foreach($assembly_constituencys as $assembly_constituency){
						...
						if($assembly_constituency->assembly_constituency_id == $p->assembly_constituency_id) echo " selected  ";
			...
			<tr>
				...
				<td>		
					<select name="parliament_constituency" id="parliament_constituency_id" class="form-control" required>
					<option value="">--SELECT--</option>
					<?php foreach($parliament_constituencys as $parliament_constituency){
						...
						if($parliament_constituency->parliament_constituency_id == $p->parliament_constituency_id) echo " selected  ";
	...
	<thead><th>S.No</th><th>Project ID</th><th>Project Name</th><th>Grant</th><th>Status</th></thead>
	<tbody>
	<?php
	$i=1;
