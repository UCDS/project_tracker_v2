	...
	<div class="col-md-10">
	<div class="col-md-7">
	<h3>Projects in <?php echo $projects[0]->division;?> <small>Click on any one to view </small></h3>
	<small>All amounts are shown in Lakhs of rupees</small>
	</div>
	<div class="col-md-5">
 	<?php echo form_open('reports/divisions',array('id'=>'select_month','role'=>'form','class'=>'form-custom'));?>
