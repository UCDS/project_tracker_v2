		...
		<?php if(isset($project) && count($project)>0) { ?>
			...
			<div class="row" style="border:1px solid #ccc;border-radius:0.2em;">
				<div class="col-md-6">
					...
					<div class="col-md-7">
						<?php echo $p->assembly_constituency;?>
					</div>
					</div>
					<div class="row alternate">
					<div class="col-md-5">
					...
					<div class="col-md-7">
						<?php echo $p->parliament_constituency;?>
					</div>
					</div>
					<div class="row alternate">
					<div class="col-md-5">
					...
					<div class="col-md-7">
						<?php if(!!$p->road_length_target) echo $p->road_length_target." Kms";?>
					</div>
					</div>
					<div class="row alternate">
					<div class="col-md-5">
					...
					<div class="col-md-7">
						<?php if(!!$p->road_length_completed) echo $p->road_length_completed." Kms";?>
					</div>
					</div>
				</div>
